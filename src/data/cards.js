...
export const CARD_DATABASE = {
  ...
  // Lee Sin
  LeeQ: { id: 'LeeQ', name: '音波回音', type: 'ATTACK', cost: 1, value: 7, rarity: 'COMMON', hero: 'LeeSin', target: 'single', effect: 'CHAIN_TRIGGER', effectValue: 7, description: '对目标造成7伤；命中后可免费再触发一次（0费）。', img: `${SPELL_URL}/BlindMonkQ.png`, price: 50 },
  LeeW: { id: 'LeeW', name: '金钟罩', type: 'SKILL', cost: 1, value: 8, block: 8, rarity: 'UNCOMMON', hero: 'LeeSin', target: 'self', effect: 'ATTACK_BUFF', effectValue: 2, description: '获得8护甲；下一次攻击+2伤害。', img: `${SPELL_URL}/BlindMonkW.png`, price: 80 },
  LeeE: { id: 'LeeE', name: '天雷破', type: 'ATTACK', cost: 1, value: 6, rarity: 'UNCOMMON', hero: 'LeeSin', target: 'single', effect: 'WEAK_ON_HIT', effectValue: 1, description: '对目标造成6伤并施加1层虚弱。', img: `${SPELL_URL}/BlindMonkE.png`, price: 100 },
  LeeR: { id: 'LeeR', name: '猛龙摆尾', type: 'ATTACK', cost: 3, value: 20, rarity: 'RARE', hero: 'LeeSin', target: 'single', effect: 'REMOVE_BUFF', effectValue: 1, description: '对目标造成20伤并移除目标的一个增益。', img: `${SPELL_URL}/BlindMonkR.png`, price: 150 },
  ...
  Neutral_015: { id: 'Neutral_015', name: '金币押注', type: 'SKILL', cost: 0, value: 0, rarity: 'RARE', hero: 'Neutral', target: 'self', effect: 'GAMBLE', effectValue: 30, failHpPenalty: 10, description: '掷硬币：正面 +30 金币；反面失去 10 生命（不会致死）。', img: `${SPELL_URL}/SummonerTeleport.png`, price: 0 },
  ...
  Neutral_018: { id: 'Neutral_018', name: '匠魂之锤', type: 'SKILL', cost: 3, value: 0, rarity: 'RARE', hero: 'Neutral', target: 'self', effect: 'PERMA_UPGRADE_CARD', effectValue: 1, exhaust: true, singleUse: true, description: '随机让《打击》或《防御》牌数值永久 +1（立即生效，本局保留成长；一次性使用）。', img: `${SPELL_URL}/SummonerSnowball.png`, price: 220 },
  ...
  Neutral_020: { id: 'Neutral_020', name: '猎手徽章', type: 'POWER', cost: 1, value: 0, rarity: 'UNCOMMON', hero: 'Neutral', target: 'self', effect: 'TEMP_STR_ON_KILLS', effectValue: 1, exhaust: true, singleUse: true, description: '一次性：若携带此徽章击败敌人，永久获得 +1 力量后从牌组移除。', img: `${SPELL_URL}/SummonerHaste.png`, price: 120 },
  Neutral_021: { id: 'Neutral_021', name: '野心契约', type: 'SKILL', cost: 0, value: 0, rarity: 'RARE', hero: 'Neutral', target: 'self', effect: 'PERMA_STR_FOR_HP', effectValue: 1, exhaust: true, singleUse: true, description: '一次性：牺牲 5 最大生命，战斗结束后永久获得 +1 力量，并从牌组移除。', img: `${SPELL_URL}/SummonerHaste.png`, price: 0 },
  ...
  Neutral_023: { id: 'Neutral_023', name: '逆向引擎', type: 'SKILL', cost: 1, value: 0, rarity: 'UNCOMMON', hero: 'Neutral', target: 'self', effect: 'RECYCLE', effectValue: 1, description: '随机将本场战斗已打出的 1 张牌重新拿回手牌。', img: `${SPELL_URL}/SummonerFlash.png`, price: 80 },
  ...
  Neutral_025: { id: 'Neutral_025', name: '随风信笺', type: 'SKILL', cost: 0, value: 0, rarity: 'COMMON', hero: 'Neutral', target: 'self', effect: 'DISCOUNT_ONE_CARD', effectValue: 1, description: '随机选择 1 张手牌，使其本回合费用 -1。', img: `${SPELL_URL}/SummonerGhost.png`, price: 40 },
  Neutral_026: { id: 'Neutral_026', name: '暗金卷轴', type: 'SKILL', cost: 2, value: 0, rarity: 'RARE', hero: 'Neutral', target: 'self', effect: 'UPGRADE_CARD', effectValue: 1, description: '本战斗中，将手牌里的《打击》或《防御》升级为 + 版本。', img: `${SPELL_URL}/SummonerSnowball.png`, price: 200 },
  ...
  Neutral_029: { id: 'Neutral_029', name: '虚弱契约', type: 'SKILL', cost: 0, value: 0, rarity: 'UNCOMMON', hero: 'Neutral', target: 'single', effect: 'STR_DEBUFF', effectValue: 3, description: '使目标获得 3 层虚弱。', img: `${SPELL_URL}/SummonerExhaust.png`, price: 60 },
  Neutral_030: { id: 'Neutral_030', name: '重塑石', type: 'SKILL', cost: 2, value: 0, rarity: 'RARE', hero: 'Neutral', target: 'self', effect: 'TRANSFORM', effectValue: 0, description: '随机将手上一张卡替换为同稀有度另一张卡（若缺少RARE则降级为UNCOMMON）。', img: `${SPELL_URL}/SummonerFlash.png`, price: 200 },
  ...
  Neutral_056: {
    ...
    rarity: 'RARE',
    hero: 'Neutral',
    effect: 'FIRST_ATTACK_PLUS_2_TURNS',
    effectValue: 4,
    description: '打出后，未来2回合，第一张攻击牌额外造成4点伤害。',
    img: `${SPELL_URL}/SummonerHaste.png`,
    price: 120
  },
  Neutral_057: {
    id: 'Neutral_057',
...
Object.entries(NEUTRAL_CARD_CDN).forEach(([id, url]) => {
  if (CARD_DATABASE[id]) {
    CARD_DATABASE[id].img = url;
  }
});
