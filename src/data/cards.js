...
export const CARD_DATABASE = {
  ...
  LeeW: { id: 'LeeW', name: '金钟罩', type: 'SKILL', cost: 1, value: 8, block: 8, rarity: 'UNCOMMON', hero: 'LeeSin', target: 'self', effect: 'ATTACK_BUFF', effectValue: 2, description: '获得8护甲；下一次攻击+2伤害。', img: `${SPELL_URL}/LeeW.png`, price: 80 },
  ...
  Neutral_027: { id: 'Neutral_027', name: '毒饵之箱', type: 'SKILL', cost: 3, value: 0, rarity: 'RARE', hero: 'Neutral', target: 'mark', effect: 'BAIT_TRIGGER', effectValue: 8, description: '放置诱饵：敌人行动前触发 8 层中毒（TRAP!）。', img: `${SPELL_URL}/SummonerExhaust.png`, price: 80 },
