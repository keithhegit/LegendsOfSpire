...
- **v0.8.0** (2025-11-21) ⭐ **当前版本**:
  - ✨ 全英雄实装：新增10位英雄 (瑞文、卡牌、盲僧、薇恩、提莫、劫、内瑟斯、艾瑞莉娅、锤石、卡特琳娜)
  - ✨ 全部被动技能实装：20/20 英雄被动技能完整实现
  - ✨ 永久成长机制：3位成长型英雄（内瑟斯/锤石/卡牌大师）
  - ✨ Toast通知系统：永久成长获得时的视觉反馈
  - ✨ 音频解锁机制：解决浏览器自动播放限制
  - ✨ 商店/事件扩展：卡牌升级、法力购买、随机升级
  - 🐛 修复：英雄解锁、护甲累积、地图生成、卡牌升级等
  - 📝 完整文档：6份技术文档（平衡性、被动技能、审计报告等）
  - 🎮 总计：20位英雄、82张卡牌、30个遗物

---

> **提示**：本文档基于 `v0.8.0` (main分支) 生成，数据与生产环境游戏实时同步。如有变更请参考源代码 `src/data/` 目录或访问 https://lol.keithhe.com 。
